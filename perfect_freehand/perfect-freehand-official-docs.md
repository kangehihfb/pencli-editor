# perfect-freehand (Official Docs Snapshot)

Source: <https://www.npmjs.com/package/perfect-freehand>  
Repository: <https://github.com/steveruizok/perfect-freehand>  
Homepage: <https://github.com/steveruizok/perfect-freehand#readme>

---

# perfect-freehand

1.2.3 · Published Feb 1, 2026
...
- License: MIT
- Unpacked Size: 109.5KB
- Total Files: 27
- Author: Steve Ruiz
- Keywords: ink, draw, paint, signature, handwriting, text, drawing, painting
- 0 Dependencies
- 245 Dependents
- 57 Versions
...
| --- | --- | --- | --- |
| 1.2.0 - 1.2.3 | Sep 2022 - Feb 2026 | 4 | - |
| 1.1.0 | Jun 1, 2022 | 1 | - |
| 1.0.0 - 1.0.16 | Sep 2021 - Oct 2021 | 17 | 2 |
| 0.5.0 - 0.5.4 | Aug 2021 - Sep 2021 | 5 | 2 |
| 0.4.0 - 0.4.10 | Apr 2021 - Jul 2021 | 13 | - |
| 0.3.0 - 0.3.5 | Mar 2021 | 6 | - |
| 0.2.0 - 0.2.5 | Feb 2021 - Mar 2021 | 6 | 1 |
| 0.1.0 - 0.1.5 | Feb 2021 | 5 | 1 |

57 versions · first published Feb 19, 2021
...
│   ├── types/
│   │   ├── bench/
│   │   │   ├── stroke.bench.d.ts (53B)
│   │   │   └── stroke.bench.d.ts.map (130B)
│   │   ├── constants.d.ts (1.9KB)
│   │   ├── constants.d.ts.map (681B)
│   │   ├── getStroke.d.ts (1.1KB)
│   │   ├── getStroke.d.ts.map (383B)
│   │   ├── getStrokeOutlinePoints.d.ts (1.0KB)
│   │   ├── getStrokeOutlinePoints.d.ts.map (333B)
│   │   ├── getStrokePoints.d.ts (1.2KB)
│   │   ├── getStrokePoints.d.ts.map (436B)
│   │   ├── getStrokeRadius.d.ts (56B)
│   │   ├── getStrokeRadius.d.ts.map (127B)
│   │   ├── index.d.ts (233B)
│   │   ├── index.d.ts.map (255B)
│   │   ├── simulatePressure.d.ts (57B)
│   │   ├── simulatePressure.d.ts.map (129B)
│   │   ├── types.d.ts (1.6KB)
│   │   ├── types.d.ts.map (941B)
│   │   ├── vec.d.ts (44B)
│   │   └── vec.d.ts.map (103B)
...
> Note: This file is a snapshot generated from the npm package page and may differ from the latest GitHub README as the project updates.
